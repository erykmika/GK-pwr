...
def render(time):
    global theta, phi, scale, R, x_eye, y_eye, z_eye, delta_x, delta_y
    ...
    if right_mouse_button_pressed:
        phi += delta_y * 0.15 * pix2angle
        theta += delta_x * 0.15 * pix2angle
        ...
        z_eye = R * cos(theta * (pi / 180)) * cos(phi * (pi / 180))
